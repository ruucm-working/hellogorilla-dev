...
class Cosmosfarm_Members_Skin {
	...
	public function login_form($form, $action){
		...
		if(file_exists(COSMOSFARM_MEMBERS_DIR_PATH . "/skin/{$option->skin}/login-form.php")){
			ob_start();
			include COSMOSFARM_MEMBERS_DIR_PATH . "/skin/{$option->skin}/login-form.php";
			$form = ob_get_clean();
		}
	...
	public function change_password_form($form, $action){
		...
		if(file_exists(COSMOSFARM_MEMBERS_DIR_PATH . "/skin/{$option->skin}/change-password-form.php")){
			ob_start();
			include COSMOSFARM_MEMBERS_DIR_PATH . "/skin/{$option->skin}/change-password-form.php";
			$form = ob_get_clean();
		}
	...
	public function account_links(){
		...
		if(file_exists(COSMOSFARM_MEMBERS_DIR_PATH . "/skin/{$option->skin}/account-links.php")){
			ob_start();
			include COSMOSFARM_MEMBERS_DIR_PATH . "/skin/{$option->skin}/account-links.php";
			$layout = ob_get_clean();
		}
	...
	public function login_timeout_popup($login_timeout_url, $login_timeout){
		...
		if(file_exists(COSMOSFARM_MEMBERS_DIR_PATH . "/skin/{$option->skin}/login-timeout-popup.php")){
			ob_start();
			include COSMOSFARM_MEMBERS_DIR_PATH . "/skin/{$option->skin}/login-timeout-popup.php";
			$layout= ob_get_clean();
		}
