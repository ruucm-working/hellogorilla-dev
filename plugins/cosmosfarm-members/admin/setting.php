			...
			<tbody>
				<tr valign="top">
					...
					<td>
						...
						<p class="description">레이아웃 깨짐 또는 색상변경 등 문의는 <a href="http://www.cosmosfarm.com/threads" onclick="window.open(this.href);return false;">워드프레스 커뮤니티</a>에 올려주시면 도움 받으실 수 있습니다.</p>
						<p class="description">스킨 디자인을 기증해주시면 코스모스팜 회원관리 플러그인에 추가해서 업데이트하겠습니다. <a href="http://www.cosmosfarm.com/support" onclick="window.open(this.href);return false;">문의하기</a></p>
					</td>
				</tr>
				<tr valign="top">
				...
				<tr valign="top">
					...
					<td>
						...
						<p class="description"><code>[wpmem_profile]</code> 숏코드가 삽입된 회원정보 페이지를 선택해주세요. 혹은 직접 페이지 주소를 입력할 수 있습니다.</p>
					</td>
				</tr>
				<tr valign="top">
				...
				<tr valign="top">
					...
					<td>
						<select id="cosmosfarm_members_page_restriction_redirect" name="cosmosfarm_members_page_restriction_redirect">
							<option value="">제한된 페이지에 로그인 화면 표시</option>
							<option value="1"<?php if($option->page_restriction_redirect == '1'):?> selected<?php endif?>>알림 후 로그인 페이지로 이동</option>
							<option value="2"<?php if($option->page_restriction_redirect == '2'):?> selected<?php endif?>>알림 없이 로그인 페이지로 이동</option>
						</select>
						<p class="description">비회원에게 로그인 화면을 보여줍니다. 페이지 제한 설정은 각 페이지 편집 화면에서 할 수 있습니다.</p>
					</td>
				</tr>
				<tr valign="top">
							...
							<ul id="cosmosfarm_members_social_login_active" style="float:left;margin:0">
								...
								<li class="ui-state-default">
									...
									<p>
										...
										<input type="text" value="<?php echo home_url('?action=cosmosfarm_members_social_login_callback_' . $channel)?>" readonly>
									</p>
									<p>
									...
									<p>
										<a href="http://blog.naver.com/chan2rrj/220959853733" onclick="window.open(this.href);return false;">네이버 소셜 로그인 설정 방법</a>
									</p>
									...
									<p>
										<a href="http://blog.naver.com/chan2rrj/220958859734" onclick="window.open(this.href);return false;">페이스북 소셜 로그인 설정 방법</a>
									</p>
									...
									<p>
										...
										<input type="text" value="<?php echo home_url('?action=cosmosfarm_members_social_login_callback_' . $channel, 'relative')?>" readonly>
									</p>
									<p>
										<a href="https://developers.kakao.com/apps/new" onclick="window.open(this.href);return false;">https://developers.kakao.com/apps/new</a> 페이지에서 애플리케이션을 등록해주세요.
									</p>
									<p>
										<a href="http://blog.naver.com/chan2rrj/220959998350" onclick="window.open(this.href);return false;">카카오 소셜 로그인 설정 방법</a>
									</p>
									...
									<p>
										<a href="http://blog.naver.com/chan2rrj/220959813418" onclick="window.open(this.href);return false;">구글+ 소셜 로그인 설정 방법</a>
									</p>
									...
									<p>
										<a href="https://apps.twitter.com/" onclick="window.open(this.href);return false;">https://apps.twitter.com/</a> 페이지에서 애플리케이션을 등록해주세요.
									</p>
									<p>
										<a href="http://blog.naver.com/chan2rrj/220959945492" onclick="window.open(this.href);return false;">트위터 소셜 로그인 설정 방법</a>
									</p>
									...
									<p>
										...
										<input type="text" value="<?php echo home_url()?>" readonly>
									</p>
									<p>
									...
									<p>
										<a href="http://blog.naver.com/chan2rrj/220960406624" onclick="window.open(this.href);return false;">인스타그램 소셜 로그인 설정 방법</a>
									</p>
									...
									<p>
										<a href="http://blog.naver.com/chan2rrj/220960346707" onclick="window.open(this.href);return false;">라인 소셜 로그인 설정 방법</a>
									</p>
									<?php endif?>
								</li>
								<?php endforeach?>
...
jQuery(function(){
	...
	jQuery("#cosmosfarm_members_social_login_active").disableSelection();
});
</script>