			...
			<tbody>
				<tr valign="top">
					...
					<td>
						...
						<p class="description"><a href="https://ko.wordpress.org/plugins/mycred/" onclick="window.open(this.href);return false;">myCRED</a> 플러그인의 포인트를 기반으로 동작합니다.</p>
						<p class="description">사용자 역할(Role)을 추가하거나 관리는 <a href="https://ko.wordpress.org/plugins/user-role-editor/" onclick="window.open(this.href);return false;">User Role Editor</a> 플러그인을 사용해주세요.</p>
					</td>
				</tr>
				<tr valign="top">
