...
define('COSMOSFARM_MEMBERS_VERSION', '1.9.2');
...
function cosmosfarm_members_init(){
	global $cosmosfarm_members, $cosmosfarm_members_skin, $cosmosfarm_members_option, $cosmosfarm_members_sms, $cosmosfarm_members_page_builder;
