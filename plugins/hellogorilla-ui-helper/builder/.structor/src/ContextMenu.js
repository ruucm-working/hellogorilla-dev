...
class ContextMenu extends Component {
  ...
  shouldComponentUpdate(nextProps, nextState) {
    ...
    return (
      nextProps.centerPointY !== centerPointY ||
  ...
  setParentList(props) {
    ...
    if (selectedKeys.length === 1) {
      ...
      if (parentList && parentList.length > 0) {
        ...
        const restNumber =
          componentNumber > showParentsNumber
            ? componentNumber - showParentsNumber
            : 0
        let item
  ...
  render() {
    ...
    return (
      ...
      >
        <div className="structor_context-menu-box" style={menuBoxStyle}>
          {parentElements}
          <div className="structor_context-menu-tab child" style={menuTabStyle}>
